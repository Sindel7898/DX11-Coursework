...
TesselationPlane::TesselationPlane(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int lresolution)
{
...
// Release resources.
TesselationPlane::~TesselationPlane()
{
...
void TesselationPlane::initBuffers(ID3D11Device* device)
{
	VertexType* vertices;
...
void TesselationPlane::sendData(ID3D11DeviceContext* deviceContext, D3D_PRIMITIVE_TOPOLOGY top)
{
	unsigned int stride;
	unsigned int offset;
